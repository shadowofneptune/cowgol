 ...
 * Trampoline frames allows for multiple levels of the goto statement.
 ...
 * incurred if the goto statement is in use. */
typedef struct {
/*:The function called by the goto statement: */
	void(*destination)(void);
/*1 if a goto statement is in use, 0 otherwise: */
	i1 activated;
/*1 if goto->trampoline, 0 if normal return->trampoline. */
	i1 passer2tramp;
 ...
 * first destination of the goto chain. Subsequent goto statements
